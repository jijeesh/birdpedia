...
func TestHandler(t *testing.T) {
	/*
		  Here, we form a new HTTP requiest. This is the requiest that's going to be
	...
	*/
	...
	/*
	  In case there is an error in formating the request, we fail and stop the test
	*/
	if err != nil {
		t.Fatal(err)
	}
	/*
		  ...
		  This recoder will act as the target of our http Request
		  (You can think of it as a mini-browser, which will accept the result
		of the http request that we make)
	*/
	...
	*/
	...
	/*
	   Serve the HTTP requiest to our recorder. This is the line that actually
	...
	*/
	...
	if status := recorder.Code; status != http.StatusOK {
		t.Errorf("handler returned wron status code: got %v want %v",
